...
/*static*/ void prefilt(image_t *src, int fc)
{
    ...
    /* FFT */
    fftw_plan fft1 = fftw_plan_dft_2d(width, height, in1, out, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(fft1);
    fftw_lock();
    ...
    /* IFFT */
    fftw_plan ifft1 = fftw_plan_dft_2d(width, height, out, in2, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(ifft1);
    fftw_lock();
    ...
    /* FFT */
    fftw_plan fft2 = fftw_plan_dft_2d(width, height, in1, out, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(fft2);
    fftw_lock();
    ...
    /* IFFT */
    fftw_plan ifft2 = fftw_plan_dft_2d(width, height, out, in2, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(ifft2);
    fftw_lock();
...
static void color_prefilt(color_image_t *src, int fc)
{
    ...
    float *fy  = (float *) fftw_malloc(width*height*sizeof(float));
    float *gfc = (float *) fftw_malloc(width*height*sizeof(float));
    fftw_complex *ina1 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *ina2 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *ina3 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *inb1 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *inb2 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *inb3 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *out1 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *out2 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *out3 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    ...
    /* FFT */
    fftw_plan fft11 = fftw_plan_dft_2d(width, height, ina1, out1, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan fft12 = fftw_plan_dft_2d(width, height, ina2, out2, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan fft13 = fftw_plan_dft_2d(width, height, ina3, out3, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(fft11);
    fftw_execute(fft12);
    fftw_execute(fft13);
    ...
    /* IFFT */
    fftw_plan ifft11 = fftw_plan_dft_2d(width, height, out1, inb1, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_plan ifft12 = fftw_plan_dft_2d(width, height, out2, inb2, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_plan ifft13 = fftw_plan_dft_2d(width, height, out3, inb3, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(ifft11);
    fftw_execute(ifft12);
    fftw_execute(ifft13);
    ...
    /* FFT */
    fftw_plan fft21 = fftw_plan_dft_2d(width, height, ina1, out1, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(fft21);
    fftw_lock();
    ...
    /* IFFT */
    fftw_plan ifft2 = fftw_plan_dft_2d(width, height, out1, inb1, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_unlock();
    fftw_execute(ifft2);
    fftw_lock();
    ...
    /* Free */
    fftw_destroy_plan(fft11);
    fftw_destroy_plan(fft12);
    fftw_destroy_plan(fft13);
    fftw_destroy_plan(ifft11);
    fftw_destroy_plan(ifft12);
    fftw_destroy_plan(ifft13);
    fftw_destroy_plan(fft21);
    fftw_destroy_plan(ifft2);
...
/*static*/ float *gist_gabor(image_t *src, const int w, image_list_t *G)
{
    ...
    /* FFT */
    fftw_plan fft = fftw_plan_dft_2d(width, height, in1, out1, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan ifft = fftw_plan_dft_2d(width, height, out2, in2, FFTW_BACKWARD, FFTW_ESTIMATE);
...
static float *color_gist_gabor(color_image_t *src, const int w, image_list_t *G)
{
    ...
    fftw_complex *inb2  = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *inb3  = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outa1 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outa2 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outa3 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outb1 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outb2 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    fftw_complex *outb3 = (fftw_complex *) fftw_malloc(width*height*sizeof(fftw_complex));
    ...
    /* FFT */
    fftw_plan fft1  = fftw_plan_dft_2d(width, height, ina1, outa1, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan fft2  = fftw_plan_dft_2d(width, height, ina2, outa2, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan fft3  = fftw_plan_dft_2d(width, height, ina3, outa3, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan ifft1 = fftw_plan_dft_2d(width, height, outb1, inb1, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_plan ifft2 = fftw_plan_dft_2d(width, height, outb2, inb2, FFTW_BACKWARD, FFTW_ESTIMATE);
    fftw_plan ifft3 = fftw_plan_dft_2d(width, height, outb3, inb3, FFTW_BACKWARD, FFTW_ESTIMATE);
